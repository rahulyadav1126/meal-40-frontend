  ...
  return (
    <footer className="mt-40 bg-[#383838] text-gray-300 relative pb-0 before:absolute before:-top-8 before:left-0 before:w-full before:h-16 before:bg-[#383838] before:[clip-path:polygon(0_100%,100%_0,100%_100%,0_100%)] before:-z-10">
      <div className="p40-container">
        {/* Newsletter Section */}
        <div ref={parallaxRef} className="relative mx-auto max-w-5xl -top-24 border-[8px] border-[#f58220] rounded flex flex-col p-10 md:p-14 gap-8 shadow-[0_10px_25px_rgba(0,0,0,0.1)] -mb-16 overflow-hidden min-h-[300px] justify-center items-center text-center">

          {/* Parallax Background */}
          <div className="absolute inset-0 w-full h-[150%] -top-[25%] parallax-bg z-0 pointer-events-none will-change-transform">
            <img src="/footer2.jpeg" alt="Background" className="w-full h-full object-cover" />
          ...
          {/* <div className="absolute inset-0 w-full h-[150%] -top-[25%] parallax-bg z-0 pointer-events-none will-change-transform">
            <video
              ...
              playsInline
            >
              <source src="/footer1.mp4" type="video/mp4" />
            </video>
            <div className="absolute inset-0 bg-black/10"></div>
          </div> */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1.2fr] gap-12 pb-16 items-start">
          ...
          <div className="flex flex-col items-start">
            <Link className="inline-block mb-6" href={ROUTES.customer.home}>
              <img src="/logo.png" alt="Plate40" className="h-16 w-auto object-contain" />
            </Link>

            <p className="text-gray-300 text-[0.95rem] leading-[1.7] m-0 mb-6 max-w-sm">
          ...
          <div className="flex flex-col">
            ...
            <ul className="flex flex-col gap-3 m-0 p-0 list-none">
              <li><Link className="text-[#a3a3a3] no-underline text-[0.95rem] transition-colors flex items-center before:content-['→'] before:mr-2 before:text-xs before:text-[#666] before:transition-colors hover:text-[#f58220] hover:before:text-[#f58220]" href="/about-us">About Us</Link></li>
              <li><Link className="text-[#a3a3a3] no-underline text-[0.95rem] transition-colors flex items-center before:content-['→'] before:mr-2 before:text-xs before:text-[#666] before:transition-colors hover:text-[#f58220] hover:before:text-[#f58220]" href="/direct-support">Direct Support</Link></li>
              <li><Link className="text-[#a3a3a3] no-underline text-[0.95rem] transition-colors flex items-center before:content-['→'] before:mr-2 before:text-xs before:text-[#666] before:transition-colors hover:text-[#f58220] hover:before:text-[#f58220]" href="/help">Help & Support</Link></li>
